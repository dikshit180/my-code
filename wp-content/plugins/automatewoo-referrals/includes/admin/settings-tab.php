	...
	function load_settings() {
		...
		$this->add_setting(
			...
			[
				...
				'tooltip'     => __( 'This URL is used when an advocate shares via email, Facebook or X. If you are using link based referrals then the tracking parameter will be automatically added to this URL. You can also add analytics tracking parameters to the URL.', 'automatewoo-referrals' ),
			...
			$this->add_setting(
				...
				[
					...
					'desc'  => sprintf(
						...
						'<a href="https://woocommerce.com/document/subscriptions/payment-gateways/#feature-explanation" target="_blank">',
						'</a>'
					),
					'type'  => 'checkbox',
				]
		...
		$this->add_setting(
			...
			[
				'title' => __( 'Enable sharing via X', 'automatewoo-referrals' ),
				'type'  => 'checkbox',
			]
		);
		...
		$this->add_setting(
			...
			[
				...
				'type'    => 'textarea',
				'tooltip' => __( "This is the default text used when an advocate shares via X or WhatsApp. This feature is not supported by Facebook. If you chose 'Coupon Based' you must include the variable {{ coupon_code }}. A link to your shop will be added automatically.", 'automatewoo-referrals' ),
			]
		);
		...
		$this->add_setting(
			...
			[
				'title'   => __( 'X default share text (optional)', 'automatewoo-referrals' ),
				'type'    => 'textarea',
				'tooltip' => __( "Optionally specify different text for X shares as they are limited to 280 characters. If left blank the default share text will be used.", 'automatewoo-referrals' ),
			]
		);
