...
class Options extends AutomateWoo\Options_API {
	...
	function __construct() {
		$this->defaults = [
			...
			'widget_text' => __( 'Invite a friend via Facebook, X or email and they’ll get a $20 welcome credit, plus you’ll get $20 in your own account with their first order, as our little thank you.', 'automatewoo-referrals' ),
