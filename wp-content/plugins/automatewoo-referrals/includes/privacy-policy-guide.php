...
<div class="wp-suggested-text">
	...
	<p class="privacy-policy-tutorial"><?php esc_html_e( "Refer A Friend allows advocates to share via email, Facebook or X. Their personal data may be used in this process.", 'automatewoo-referrals' ); ?></p>
	<p><?php self::suggest_text_html(); ?> <?php esc_html_e( 'If you choose to use our customer referral program, your personal data, such as your name and your unique referral code, may be shared with those you choose to share with. This data may be shared via Facebook, X or email if you click on the share buttons or submit the share via email form.', 'automatewoo-referrals' ); ?></p>
</div>
		<?php
		return ob_get_clean();
	}
